...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_33_L3_SEL                              4

    * Configures MIO Pin 33 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180084, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_33_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
    ...
    * rt Databus)
    *  PSU_IOU_SLCR_MIO_PIN_34_L3_SEL                              4

    * Configures MIO Pin 34 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180088, 0x000000FEU ,0x00000080U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_34_OFFSET, 0x000000FEU, 0x00000080U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18015C, 0x03FFFFFFU ,0x01FFFE75U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL3_OFFSET,
		0x03FFFFFFU, 0x01FFFE75U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(4,0,4,0,3,0,2,3);
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410010, 0x00000077U ,0x00000032U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000077U, 0x00000032U);
/*##################################################################### */
