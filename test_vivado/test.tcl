...
################################################################
# This is a generated script based on design: zrf16_49dr_bd
#
...
if { $list_projs eq "" } {
   create_project zrf16_${design_name} myproj -part xczu49dr-ffvf1760-2-e
}
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set axil_arst_n [ create_bd_port -dir O -from 0 -to 0 -type rst axil_arst_n ]
  set axil_rst [ create_bd_port -dir O -from 0 -to 0 -type rst axil_rst ]
  set pl_sys_clk [ create_bd_port -dir O -type clk pl_sys_clk ]

  # Create instance: axi_proto_conv, and set properties
  set axi_proto_conv [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_converter:2.1 axi_proto_conv ]
  set_property -dict [ list \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.ID_WIDTH {16} \
  ...
  # Create instance: mpsoc, and set properties
  set mpsoc [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 mpsoc ]
  set_property -dict [ list \
...
MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#SPI 1#SPI 1#SPI 1#SPI 1#SPI 1#SPI 1#GPIO1\
MIO#SD 1#SD 1#SD 1#SD 1#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB\
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  connect_bd_intf_net -intf_net axi_proto_conv_M_AXI [get_bd_intf_ports M_AXI] [get_bd_intf_pins axi_proto_conv/M_AXI]
  connect_bd_intf_net -intf_net mpsoc_M_AXI_HPM0_FPD [get_bd_intf_pins axi_proto_conv/S_AXI] [get_bd_intf_pins mpsoc/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net axil_arst_n [get_bd_ports axil_arst_n] [get_bd_pins axi_proto_conv/aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn]
  connect_bd_net -net axil_rst [get_bd_ports axil_rst] [get_bd_pins proc_sys_reset/peripheral_reset]
  connect_bd_net -net pl_resetn [get_bd_pins mpsoc/pl_resetn0] [get_bd_pins proc_sys_reset/ext_reset_in]
  connect_bd_net -net pl_sys_clk [get_bd_ports pl_sys_clk] [get_bd_pins axi_proto_conv/aclk] [get_bd_pins mpsoc/maxihpm0_fpd_aclk] [get_bd_pins mpsoc/pl_clk0] [get_bd_pins proc_sys_reset/slowest_sync_clk]
